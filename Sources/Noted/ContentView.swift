...
struct ContentView: View {
    @StateObject private var notesService = MockNotesService()
    @StateObject private var searchService: MockSearchService
    
    init() {
        let notesService = MockNotesService()
        self._notesService = StateObject(wrappedValue: notesService)
        self._searchService = StateObject(wrappedValue: MockSearchService(notesService: notesService))
        self._selectedNote = State(initialValue: notesService.notes.first)
    }
